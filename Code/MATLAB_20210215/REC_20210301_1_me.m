...
duration = length(p_red1)*(1/12)/60 + 0.5;
...
figure
findpeaks(data_RR,time_RR_sec,'MinPeakDistance',0.06*60);
[pks,index] = findpeaks(data_RR,time_RR_sec,'MinPeakDistance',0.06*60);
