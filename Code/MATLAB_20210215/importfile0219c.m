function calInMouthtapeallcoveredglue = importfile0219c(workbookFile, sheetName, dataLines)
%IMPORTFILE1 Import data from a spreadsheet
%  CALINMOUTHTAPEALLCOVEREDGLUE = IMPORTFILE1(FILE) reads data from the
%  first worksheet in the Microsoft Excel spreadsheet file named FILE.
%  Returns the numeric data.
%
%  CALINMOUTHTAPEALLCOVEREDGLUE = IMPORTFILE1(FILE, SHEET) reads from
%  the specified worksheet.
%
%  CALINMOUTHTAPEALLCOVEREDGLUE = IMPORTFILE1(FILE, SHEET, DATALINES)
...
%  See also READTABLE.
%
% Auto-generated by MATLAB on 19-Feb-2021 15:18:16
...
% Import the data
calInMouthtapeallcoveredglue = readtable(workbookFile, opts, "UseExcel", false);

for idx = 2:size(dataLines, 1)
    opts.DataRange = "A" + dataLines(idx, 1) + ":B" + dataLines(idx, 2);
    tb = readtable(workbookFile, opts, "UseExcel", false);
    calInMouthtapeallcoveredglue = [calInMouthtapeallcoveredglue; tb]; %#ok<AGROW>
end

%% Convert to output type
calInMouthtapeallcoveredglue = table2array(calInMouthtapeallcoveredglue);
end