...
[P1_2_pbf,f2_pbf] = freq_analysis(pbf_signal_2);
...
title("Subject 1 - Nitrile covering - Filtered Signal");
xlabel("time [min]")
ylabel("Pressure [cmH2O]");
...
% xlabel("time [min]")
% ylabel("Pressure [cmH2O]");
% title("Subject2 - Exposed - Nose Resp")
% ylim ([-5 10]);
% xlim([0 duration2]);
% 
...
title("Subject 1 - Exposed - Filtered Signal");
xlabel("time [min]")
ylabel("Pressure [cmH2O]");
ylim ([ylimmin ylimmax]);
hold on
...
% xlabel("time [min]")
% ylabel("Pressure [cmH2O]");
% title("Subject3 - Polyimide - Nose Resp")
% ylim ([-5 10]);
% xlim([0 duration3]);
% 
...
title("Subject 1 - Polyimide - Filtered Signal");
xlabel("time [min]")
ylabel("Pressure [cmH2O]");
ylim ([ylimmin ylimmax]);
hold on
...
%%%%%%%%%%%%%%%%%
figure
plot(t1,pbf_signal_1, 'r');
hold on
yline(mean_peak_1, '--r', 'Nitrile')
hold on
plot(t2,pbf_signal_2, 'g');
hold on
yline(mean_peak_2, '--g', 'Exposed')
hold on
plot(t3,pbf_signal_3, 'b');
hold on
yline(mean_peak_3, '--b', 'Polyimide')
title("Filtered Signals");
legend("Nitrile", "Exposed", "Polyimide");
...
% Fs=12;
% %fmax = 0.5;  %f limits of the graphs
% fpass = [0.1 fmax];
% 
...
% %ylim ([ylimmin ylimmax]);
% 
% subplot (4,3,10) %signal filtered spectrum
% stem(f1_pbf,P1_1_pbf) 
% title('Single-Sided Amplitude Spectrum')
% xlabel('f (Hz)')
% ylabel('Power')
...
% %ylim ([ylimmin ylimmax]);
% 
% subplot (4,3,11) %signal filtered spectrum
% stem(f2_pbf,P1_2_pbf) 
% title('Single-Sided Amplitude Spectrum')
% xlabel('f (Hz)')
% ylabel('Power')
...
% 
% 
% subplot (4,3,12) %signal filtered spectrum
% stem(f3_pbf,P1_3_pbf) 
% title('Single-Sided Amplitude Spectrum')
% xlabel('f (Hz)')
% ylabel('Power')
...
%  x = Me_Exp_COMPLopen(:,2);
%  y = Me_Exp_COMPLopen(:,2);
%  N = length(x);
% [c,lags] = xcorr(x,x,'coeff');
% figure
% stem(lags,c)
...
% Fs=12;
% %fmax = 0.35;  %f limits of the graphs
% fpass = [0.1 fmax];
% 
...
Fs=12;
%fmax1 = 0.4;  %f limits of the graphs
fpass = [0.1 fmax1];
