function Me4mouthSEMIopen = importfile0302_me4_semiOpen(workbookFile, sheetName, dataLines)
%IMPORTFILE Import data from a spreadsheet
%  ME4MOUTHSEMIOPEN = IMPORTFILE(FILE) reads data from the first
%  worksheet in the Microsoft Excel spreadsheet file named FILE.
%  Returns the numeric data.
%
%  ME4MOUTHSEMIOPEN = IMPORTFILE(FILE, SHEET) reads from the specified
%  worksheet.
%
%  ME4MOUTHSEMIOPEN = IMPORTFILE(FILE, SHEET, DATALINES) reads from the
...
%  See also READTABLE.
%
% Auto-generated by MATLAB on 02-Mar-2021 21:38:42
...
% Import the data
Me4mouthSEMIopen = readtable(workbookFile, opts, "UseExcel", false);

for idx = 2:size(dataLines, 1)
    opts.DataRange = "A" + dataLines(idx, 1) + ":B" + dataLines(idx, 2);
    tb = readtable(workbookFile, opts, "UseExcel", false);
    Me4mouthSEMIopen = [Me4mouthSEMIopen; tb]; %#ok<AGROW>
end

%% Convert to output type
Me4mouthSEMIopen = table2array(Me4mouthSEMIopen);
end