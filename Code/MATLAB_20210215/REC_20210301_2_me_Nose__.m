...
Me2_aftertraining = importfile0301_me("C:\Users\Alessandro\Desktop\Polimi\Chicago Double Degree\5. Thesis\MyCode\MATLAB_20210215\File JSON\2021_03_01-Me2_training_and after.xlsx", "2021_03_01-Me_training_and afte", [1010, 3511]);

%% assign variables
data_elliptical_nodeg = Me2_aftertraining;
...
xlabel("time [min]")
ylabel("Pressure [cmH2O]");
title("Raw signal - Nose Respiration")
ylim ([-5 9]);
xlim([0 duration]);
...
plot(t1,data_passbandfilter, 'b');
title("Filtered Signal - passband [0.1 0.4] Hz");
xlabel("time [min]")
ylabel("Pressure [cmH2O]");
ylim ([-6 +9]);
xlim([0 duration]);
